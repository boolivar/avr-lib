...
{
	T0_WG_NORMAL = 0,
	T0_WG_PWM_PHASE_CORRECT = 1,
	T0_WG_CTC = 2,
	T0_WG_FAST_PWM = 3,
	T0_WG_PWM_PHASE_CORRECT_OCRA = 5,
	T0_WG_FAST_PWM_OCRA = 7,
} timer0_wg_mode_enum;
...
typedef enum
{
	TIMER0_OVERFLOW_INTERRUPT = 1,
	TIMER0_OUTPUT_COMPARE_A_MATCH_INTERRUPT = 2,
	TIMER0_OUTPUT_COMPARE_B_MATCH_INTERRUPT = 4,
	TIMER0_ALL_INTERRUPTS = 7,
} timer0_int_enum;
...
typedef enum
{
	...
	TIMER1_OUTPUT_COMPARE_A_MATCH_INTERRUPT,
	TIMER1_OUTPUT_COMPARE_B_MATCH_INTERRUPT,
	TIMER1_OVERFLOW_INTERRUPT,
	TIMER1_ALL_INTERRUPTS
} timer1_int_enum;
